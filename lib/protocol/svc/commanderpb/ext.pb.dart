...
class TestReq extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestReq', package: const $pb.PackageName(_omitMessageNames ? '' : 'svc.commander'), createEmptyInstance: create)
...
class TestRes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestRes', package: const $pb.PackageName(_omitMessageNames ? '' : 'svc.commander'), createEmptyInstance: create)
...
class commanderExtApi {
  $pb.RpcClient _client;
  commanderExtApi(this._client);

  $async.Future<TestRes> test($pb.ClientContext? ctx, TestReq request) =>
    _client.invoke<TestRes>(ctx, 'commanderExt', 'Test', request, TestRes())
  ;
}
