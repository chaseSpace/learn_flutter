...
class TestIntReq extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestIntReq', package: const $pb.PackageName(_omitMessageNames ? '' : 'svc.commander'), createEmptyInstance: create)
...
class TestIntRes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestIntRes', package: const $pb.PackageName(_omitMessageNames ? '' : 'svc.commander'), createEmptyInstance: create)
...
class commanderIntApi {
  $pb.RpcClient _client;
  commanderIntApi(this._client);

  $async.Future<TestIntRes> testInt($pb.ClientContext? ctx, TestIntReq request) =>
    _client.invoke<TestIntRes>(ctx, 'commanderInt', 'TestInt', request, TestIntRes())
  ;
}
