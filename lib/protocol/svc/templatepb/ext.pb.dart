...
class TestReq extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestReq', package: const $pb.PackageName(_omitMessageNames ? '' : 'svc.template'), createEmptyInstance: create)
...
class TestRes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestRes', package: const $pb.PackageName(_omitMessageNames ? '' : 'svc.template'), createEmptyInstance: create)
...
class templateExtApi {
  $pb.RpcClient _client;
  templateExtApi(this._client);

  $async.Future<TestRes> test($pb.ClientContext? ctx, TestReq request) =>
    _client.invoke<TestRes>(ctx, 'templateExt', 'Test', request, TestRes())
  ;
}
