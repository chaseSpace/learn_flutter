...
class TestIntReq extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestIntReq', package: const $pb.PackageName(_omitMessageNames ? '' : 'svc.template'), createEmptyInstance: create)
...
class TestIntRes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestIntRes', package: const $pb.PackageName(_omitMessageNames ? '' : 'svc.template'), createEmptyInstance: create)
...
class templateIntApi {
  $pb.RpcClient _client;
  templateIntApi(this._client);

  $async.Future<TestIntRes> testInt($pb.ClientContext? ctx, TestIntReq request) =>
    _client.invoke<TestIntRes>(ctx, 'templateInt', 'TestInt', request, TestIntRes())
  ;
}
